...
result_name='{}_gaussian_normalised_lgb_lr_1'.format(train_dataset)
...
X_train, X_val, Y_train, Y_val = train_test_split(train.drop(columns=['unit_sales']), train['unit_sales'].values, test_size=0.2, random_state=42)
...
with open('../models_new/model_{}.pkl'.format(result_name), 'wb') as fout:
